...
function Stuck() {
    ...
    if (onboard[currpawn] == 0||currPos+num>44) {
        if (DontHaveOtherFree()||currPos+num>44) {
            ...
            dice.style.backgroundImage = "url(Images/giphy.gif)";
...
function ResetPawn(victim) {
    ...
    switch (victim) {
        case "redpawn1": pawnToMove.style.top = 1000 + "px"; pawnToMove.style.left = 1000 + "px"; break;
            ...
            if (text.innerText === currcolor) {
                if (onboard[currpawn] === 1 || num === 6) {
                    if (onboard[currpawn] === 0) {
                        ...
                        switch (Color) {
                            case "red":
                                doc.style.left = 354 + 'px';
                                doc.style.top = 64 + "px";
                                break;

                            case "yellow":
                                doc.style.left = 255 + 'px';
                                doc.style.top = 559 + "px";
                                break;

                            case "blue":
                                doc.style.left = 552 + 'px';
                                doc.style.top = 361 + "px";
                                break;

                            case "green":
                                doc.style.left = 57 + 'px';
                                doc.style.top = 262 + "px";
                                break;
                        }
                        onboard[currpawn] = 1;
                    }
